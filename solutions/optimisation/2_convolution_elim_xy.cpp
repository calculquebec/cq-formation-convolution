                           ...
                           int lWidth, int lHalfK, int lK)
{
    ...
    for (int j = -lHalfK; j <= lHalfK; j++) {
        ...
        for (int i = -lHalfK; i <= lHalfK; i++) {
            ...
            lR += double(lImage[(j*lWidth + i)*4    ]) * lFilter[fx + fy*lK];
            lG += double(lImage[(j*lWidth + i)*4 + 1]) * lFilter[fx + fy*lK];
            lB += double(lImage[(j*lWidth + i)*4 + 2]) * lFilter[fx + fy*lK];
